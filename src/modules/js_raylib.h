	...
	static void * js_getvoid_arr(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			ret =(void *)JS_GetArrayBuffer(ctx,&size_ret,da_ret);
			ret +=offset_ret;
			size_ret -=offset_ret;
			ret =js_malloc(ctx,size_ret);
			memcpy(ret,(const void *)ret,size_ret);
	...
	static Texture js_getTexture(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Texture_class_id){
			ret =*(Texture *)JS_GetOpaque(src,js_Texture_class_id);
		}else{
	...
	static Image js_getImage(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Image_class_id){
			ret =*(Image *)JS_GetOpaque(src,js_Image_class_id);
		}else{
	...
	static Texture2D js_getTexture2D(JSContext * ctx,JSValue src,bool * error){
		Texture2D ret;
		if(JS_GetClassID(src)==js_Texture_class_id){
			ret =*(Texture2D *)JS_GetOpaque(src,js_Texture_class_id);
		}else{
	...
	static Rectangle * js_getRectangle_arr(JSContext * ctx,JSValue src,bool * error){
		Rectangle * ret;
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			size_t size_ret;
			JSValue da_ret=JS_GetTypedArrayBuffer(ctx,src,&offset_ret,&size_ret,NULL);
			ret =(Rectangle *)JS_GetArrayBuffer(ctx,&size_ret,da_ret);
			ret +=offset_ret;
			size_ret -=offset_ret;
			ret =(Rectangle *)js_malloc(ctx,size_ret);
			memcpy((void *)ret,(const void *)ret,size_ret);
			JS_FreeValuePtr(ctx,&da_ret);
		}else if(JS_IsArrayBuffer(src)){
			int64_t size_ret;
			ret =(Rectangle *)JS_GetArrayBuffer(ctx,(size_t *)&size_ret,src);
	...
	static GlyphInfo js_getGlyphInfo(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_GlyphInfo_class_id){
			ret =*(GlyphInfo *)JS_GetOpaque(src,js_GlyphInfo_class_id);
		}else{
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			for(i=0;i<size_ret;i++){
				...
				if(JS_GetClassID(src0)==js_GlyphInfo_class_id){
					ret[i] =*(GlyphInfo *)JS_GetOpaque(src0,js_GlyphInfo_class_id);
				}else{
	...
	static Vector3 js_getVector3(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Vector3_class_id){
			ret =*(Vector3 *)JS_GetOpaque(src,js_Vector3_class_id);
		}else{
	...
	static Vector2 js_getVector2(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Vector2_class_id){
			ret =*(Vector2 *)JS_GetOpaque(src,js_Vector2_class_id);
		}else{
	...
	static unsigned char * js_getunsignedchar_arr(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			size_t size_ret;
			JSValue da_ret=JS_GetTypedArrayBuffer(ctx,src,&offset_ret,&size_ret,NULL);
			ret =(unsigned char *)JS_GetArrayBuffer(ctx,&size_ret,da_ret);
			ret +=offset_ret;
			size_ret -=offset_ret;
			ret =(unsigned char *)js_malloc(ctx,size_ret);
			memcpy((void *)ret,(const void *)ret,size_ret);
			JS_FreeValuePtr(ctx,&da_ret);
		}else{
			JS_ThrowTypeError(ctx,(const char *)"src does not match type unsigned char *");
	...
	static unsigned short * js_getunsignedshort_arr(JSContext * ctx,JSValue src,bool * error){
		unsigned short * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			int64_t size_ret;
			ret =(unsigned short *)JS_GetArrayBuffer(ctx,(size_t *)&size_ret,src);
		}else if(JS_IsArray(src)){
			int64_t size_ret;
			if(JS_GetLength(ctx,src,&size_ret)==-1){
				error[0]=(bool)1;
			...
			ret =(unsigned short *)js_malloc(ctx,size_ret*sizeof(unsigned short));
			int i;
			for(i=0;i<size_ret;i++){
				JSValue src0=JS_GetPropertyUint32(ctx,src,(uint32_t)i);
				JS_FreeValue(ctx,src0);
			...
			size_t size_ret;
			JSValue da_ret=JS_GetTypedArrayBuffer(ctx,src,&offset_ret,&size_ret,NULL);
			ret =(unsigned short *)JS_GetArrayBuffer(ctx,&size_ret,da_ret);
			ret +=offset_ret;
			size_ret -=offset_ret;
			ret =(unsigned short *)js_malloc(ctx,size_ret);
			memcpy((void *)ret,(const void *)ret,size_ret);
			JS_FreeValuePtr(ctx,&da_ret);
		}else{
			JS_ThrowTypeError(ctx,(const char *)"src does not match type unsigned short *");
	...
	static Matrix js_getMatrix(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Matrix_class_id){
			ret =*(Matrix *)JS_GetOpaque(src,js_Matrix_class_id);
		}else{
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			if(JS_GetClassID(src0)==js_Matrix_class_id){
				...
				for(i=0;i<size_ret;i++){
					...
					JS_FreeValue(ctx,src0);
					if(JS_GetClassID(src0)==js_Matrix_class_id){
						ret[i] =*(Matrix *)JS_GetOpaque(src0,js_Matrix_class_id);
					}else{
			...
			size_t size_ret;
			JSValue da_ret=JS_GetTypedArrayBuffer(ctx,src,&offset_ret,&size_ret,NULL);
			ret =(Matrix *)JS_GetArrayBuffer(ctx,&size_ret,da_ret);
			ret +=offset_ret;
			size_ret -=offset_ret;
			ret =(Matrix *)js_malloc(ctx,size_ret);
			memcpy((void *)ret,(const void *)ret,size_ret);
			JS_FreeValuePtr(ctx,&da_ret);
		}else if(JS_IsArrayBuffer(src)){
			int64_t size_ret;
	...
	static int * js_getint_arr(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			size_t size_ret;
			JSValue da_ret=JS_GetTypedArrayBuffer(ctx,src,&offset_ret,&size_ret,NULL);
			ret =(int *)JS_GetArrayBuffer(ctx,&size_ret,da_ret);
			ret +=offset_ret;
			size_ret -=offset_ret;
			ret =(int *)js_malloc(ctx,size_ret);
			memcpy((void *)ret,(const void *)ret,size_ret);
			JS_FreeValuePtr(ctx,&da_ret);
		}else{
			JS_ThrowTypeError(ctx,(const char *)"src does not match type int *");
	...
	static Shader js_getShader(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Shader_class_id){
			ret =*(Shader *)JS_GetOpaque(src,js_Shader_class_id);
		}else{
	...
	static MaterialMap js_getMaterialMap(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_MaterialMap_class_id){
			ret =*(MaterialMap *)JS_GetOpaque(src,js_MaterialMap_class_id);
		}else{
	...
	static MaterialMap * js_getMaterialMap_arr(JSContext * ctx,JSValue src,bool * error){
		MaterialMap * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			ret =(MaterialMap *)js_malloc(ctx,size_ret*sizeof(MaterialMap));
			int i;
			for(i=0;i<size_ret;i++){
				JSValue src0=JS_GetPropertyUint32(ctx,src,(uint32_t)i);
				JS_FreeValue(ctx,src0);
				if(JS_GetClassID(src0)==js_MaterialMap_class_id){
					ret[i] =*(MaterialMap *)JS_GetOpaque(src0,js_MaterialMap_class_id);
				}else{
	...
	static float * js_getfloat_arr4(JSContext * ctx,JSValue src,bool * error){
		float * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			if(size_ret<4){
				JS_ThrowTypeError(ctx,(const char *)"src too short (4)");
				error[0]=(bool)1;
				return NULL;
			}
			size_ret =(int64_t)4;
	...
	static char * js_getchar_arr32(JSContext * ctx,JSValue src,bool * error){
		char * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			if(size_ret<32){
				JS_ThrowTypeError(ctx,(const char *)"src too short (32)");
				error[0]=(bool)1;
				return NULL;
			}
			size_ret =(int64_t)32;
			...
			size_t size_ret;
			JSValue da_ret=JS_GetTypedArrayBuffer(ctx,src,&offset_ret,&size_ret,NULL);
			ret =(char *)JS_GetArrayBuffer(ctx,&size_ret,da_ret);
			ret +=offset_ret;
			size_ret -=offset_ret;
			ret =(char *)js_malloc(ctx,size_ret);
			memcpy((void *)ret,(const void *)ret,size_ret);
			JS_FreeValuePtr(ctx,&da_ret);
		}else if(JS_IsString(src)){
			int64_t size_ret;
			char * js_ret=(char *)JS_ToCStringLen(ctx,(size_t *)&size_ret,src);
			ret =(char *)js_malloc(ctx,size_ret+1);
	...
	static Mesh js_getMesh(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Mesh_class_id){
			ret =*(Mesh *)JS_GetOpaque(src,js_Mesh_class_id);
		}else{
	...
	static Mesh * js_getMesh_arr(JSContext * ctx,JSValue src,bool * error){
		Mesh * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			ret =(Mesh *)js_malloc(ctx,size_ret*sizeof(Mesh));
			int i;
			for(i=0;i<size_ret;i++){
				JSValue src0=JS_GetPropertyUint32(ctx,src,(uint32_t)i);
				JS_FreeValue(ctx,src0);
				if(JS_GetClassID(src0)==js_Mesh_class_id){
					ret[i] =*(Mesh *)JS_GetOpaque(src0,js_Mesh_class_id);
				}else{
	...
	static Material js_getMaterial(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Material_class_id){
			ret =*(Material *)JS_GetOpaque(src,js_Material_class_id);
		}else{
	...
	static Material * js_getMaterial_arr(JSContext * ctx,JSValue src,bool * error){
		Material * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			ret =(Material *)js_malloc(ctx,size_ret*sizeof(Material));
			int i;
			for(i=0;i<size_ret;i++){
				JSValue src0=JS_GetPropertyUint32(ctx,src,(uint32_t)i);
				JS_FreeValue(ctx,src0);
				if(JS_GetClassID(src0)==js_Material_class_id){
					ret[i] =*(Material *)JS_GetOpaque(src0,js_Material_class_id);
				}else{
	...
	static BoneInfo js_getBoneInfo(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_BoneInfo_class_id){
			ret =*(BoneInfo *)JS_GetOpaque(src,js_BoneInfo_class_id);
		}else{
	...
	static BoneInfo * js_getBoneInfo_arr(JSContext * ctx,JSValue src,bool * error){
		BoneInfo * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			ret =(BoneInfo *)js_malloc(ctx,size_ret*sizeof(BoneInfo));
			int i;
			for(i=0;i<size_ret;i++){
				JSValue src0=JS_GetPropertyUint32(ctx,src,(uint32_t)i);
				JS_FreeValue(ctx,src0);
				if(JS_GetClassID(src0)==js_BoneInfo_class_id){
					ret[i] =*(BoneInfo *)JS_GetOpaque(src0,js_BoneInfo_class_id);
				}else{
	...
	static Transform js_getTransform(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Transform_class_id){
			ret =*(Transform *)JS_GetOpaque(src,js_Transform_class_id);
		}else{
	...
	static Transform * js_getTransform_arr(JSContext * ctx,JSValue src,bool * error){
		Transform * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			for(i=0;i<size_ret;i++){
				...
				if(JS_GetClassID(src0)==js_Transform_class_id){
					ret[i] =*(Transform *)JS_GetOpaque(src0,js_Transform_class_id);
				}else{
	...
	static Transform * * js_getTransform_arr_arr(JSContext * ctx,JSValue src,bool * error){
		Transform * * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
			...
			if(JS_GetClassID(src0)==js_ArrayProxy_class_id){
				...
				for(i=0;i<size_ret;i++){
					...
					if(JS_IsArray(src0)){
						...
						ret[i] =(Transform *)js_malloc(ctx,size_reti*sizeof(Transform));
						int i0;
						for(i0=0;i0<size_reti;i0++){
							...
							if(JS_GetClassID(src00)==js_Transform_class_id){
								ret[i][i0] =*(Transform *)JS_GetOpaque(src00,js_Transform_class_id);
							}else{
	...
	static rAudioBuffer * js_getrAudioBuffer_ptr(JSContext * ctx,JSValue src,bool * error){
		rAudioBuffer * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(js_IsArrayLength(ctx,src,(int64_t)1)){
			...
			if(JS_GetClassID(src0)==js_rAudioBuffer_class_id){
				ret =(rAudioBuffer *)JS_GetOpaque(src0,js_rAudioBuffer_class_id);
			}else{
			...
			if(JS_GetClassID(src)==js_rAudioBuffer_class_id){
				ret =(rAudioBuffer *)JS_GetOpaque(src,js_rAudioBuffer_class_id);
			}else{
	...
	static rAudioProcessor * js_getrAudioProcessor_ptr(JSContext * ctx,JSValue src,bool * error){
		rAudioProcessor * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(js_IsArrayLength(ctx,src,(int64_t)1)){
			...
			if(JS_GetClassID(src0)==js_rAudioProcessor_class_id){
				ret =(rAudioProcessor *)JS_GetOpaque(src0,js_rAudioProcessor_class_id);
			}else{
			...
			if(JS_GetClassID(src)==js_rAudioProcessor_class_id){
				ret =(rAudioProcessor *)JS_GetOpaque(src,js_rAudioProcessor_class_id);
			}else{
	...
	static AudioStream js_getAudioStream(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_AudioStream_class_id){
			ret =*(AudioStream *)JS_GetOpaque(src,js_AudioStream_class_id);
		}else{
	...
	static Matrix * js_getMatrix_arr2(JSContext * ctx,JSValue src,bool * error){
		Matrix * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			if(JS_GetClassID(src0)==js_Matrix_class_id){
				if(size_ret<2){
					JS_ThrowTypeError(ctx,(const char *)"src too short (2)");
					error[0]=(bool)1;
					return NULL;
				}
				size_ret =(int64_t)2;
	...
	static float * js_getfloat_arr2(JSContext * ctx,JSValue src,bool * error){
		float * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
			...
			if(JS_IsArrayBuffer(src0)){
				...
				for(i=0;i<size_ret;i++){
					...
					if(JS_GetClassID(src0)==JS_CLASS_INT8_ARRAY){
						...
						ret[i] =(char *)JS_GetArrayBuffer(ctx,&size_reti,da_reti);
						ret[i] +=offset_reti;
						size_reti -=offset_reti;
						ret[i] =(char *)js_malloc(ctx,size_reti);
						memcpy((void *)ret[i],(const void *)ret[i],size_reti);
				...
				for(i=0;i<size_ret;i++){
					...
					if(JS_IsString(src0)){
						...
						ret[i] =(char *)js_malloc(ctx,size_reti+1);
						memcpy((void *)ret[i],(const void *)js_reti,(size_t)size_reti);
						ret[i][size_reti]=(char)0;
						JS_FreeCString(ctx,(const char *)js_reti);
					}else{
						JS_ThrowTypeError(ctx,(const char *)"src0 does not match type char * *");
						error[0]=(bool)1;
	...
	static AutomationEvent js_getAutomationEvent(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_AutomationEvent_class_id){
			ret =*(AutomationEvent *)JS_GetOpaque(src,js_AutomationEvent_class_id);
		}else{
	...
	static AutomationEvent * js_getAutomationEvent_arr(JSContext * ctx,JSValue src,bool * error){
		AutomationEvent * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			ret =(AutomationEvent *)js_malloc(ctx,size_ret*sizeof(AutomationEvent));
			int i;
			for(i=0;i<size_ret;i++){
				JSValue src0=JS_GetPropertyUint32(ctx,src,(uint32_t)i);
				JS_FreeValue(ctx,src0);
				if(JS_GetClassID(src0)==js_AutomationEvent_class_id){
					ret[i] =*(AutomationEvent *)JS_GetOpaque(src0,js_AutomationEvent_class_id);
				}else{
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			for(i=0;i<size_ret;i++){
				...
				if(JS_GetClassID(src0)==js_Image_class_id){
					ret[i] =*(Image *)JS_GetOpaque(src0,js_Image_class_id);
				}else{
	...
	static Camera2D js_getCamera2D(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Camera2D_class_id){
			ret =*(Camera2D *)JS_GetOpaque(src,js_Camera2D_class_id);
		}else{
	...
	static Camera3D js_getCamera3D(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Camera3D_class_id){
			ret =*(Camera3D *)JS_GetOpaque(src,js_Camera3D_class_id);
		}else{
	...
	static RenderTexture2D js_getRenderTexture2D(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_RenderTexture_class_id){
			ret =*(RenderTexture2D *)JS_GetOpaque(src,js_RenderTexture_class_id);
		}else{
	...
	static VrStereoConfig js_getVrStereoConfig(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_VrStereoConfig_class_id){
			ret =*(VrStereoConfig *)JS_GetOpaque(src,js_VrStereoConfig_class_id);
		}else{
	...
	static VrDeviceInfo js_getVrDeviceInfo(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_VrDeviceInfo_class_id){
			ret =*(VrDeviceInfo *)JS_GetOpaque(src,js_VrDeviceInfo_class_id);
		}else{
		...
		if(JS_IsArray(src)){
			...
			if(JS_GetClassID(src0)==js_Vector2_class_id){
				...
				for(i=0;i<size_ret;i++){
					...
					JS_FreeValue(ctx,src0);
					if(JS_GetClassID(src0)==js_Vector2_class_id){
						ret[i] =*(Vector2 *)JS_GetOpaque(src0,js_Vector2_class_id);
					}else{
		...
		if(JS_IsArray(src)){
			...
			if(JS_GetClassID(src0)==js_Vector3_class_id){
				...
				for(i=0;i<size_ret;i++){
					...
					JS_FreeValue(ctx,src0);
					if(JS_GetClassID(src0)==js_Vector3_class_id){
						ret[i] =*(Vector3 *)JS_GetOpaque(src0,js_Vector3_class_id);
					}else{
	...
	static Vector4 * js_getVector4_ptr(JSContext * ctx,JSValue src,bool * error){
		Vector4 * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(JS_IsArray(src)){
			...
			if(JS_GetClassID(src0)==js_Vector4_class_id){
				...
				for(i=0;i<size_ret;i++){
					...
					JS_FreeValue(ctx,src0);
					if(JS_GetClassID(src0)==js_Vector4_class_id){
						ret[i] =*(Vector4 *)JS_GetOpaque(src0,js_Vector4_class_id);
					}else{
			...
			if(JS_GetClassID(src)==js_Vector4_class_id){
				ret =(Vector4 *)JS_GetOpaque(src,js_Vector4_class_id);
			}else{
				JS_ThrowTypeError(ctx,(const char *)"src does not match type Vector4 *");
				error[0]=(bool)1;
				return NULL;
	...
	static unsigned int * js_getunsignedint_ptr(JSContext * ctx,JSValue src,bool * error){
		unsigned int * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
	...
	static float * js_getfloat_arr_arg1(JSContext * ctx,JSValue src,bool * error,int size0){
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			if(size_ret<size0){
				JS_ThrowTypeError(ctx,(const char *)"src too short (size0)");
				error[0]=(bool)1;
				return NULL;
			}
			if(size_ret==0){
	...
	static Vector2 * js_getVector2_arr_arg1(JSContext * ctx,JSValue src,bool * error,int size0){
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			if(JS_GetClassID(src0)==js_Vector2_class_id){
				...
				if(size_ret<size0*2){
					JS_ThrowTypeError(ctx,(const char *)"src too short (size0*2)");
					error[0]=(bool)1;
					return NULL;
				}
				size_ret -=size_ret%2;
			...
			size_t size_ret;
			JSValue da_ret=JS_GetTypedArrayBuffer(ctx,src,&offset_ret,&size_ret,NULL);
			ret =(Vector2 *)JS_GetArrayBuffer(ctx,&size_ret,da_ret);
			ret +=offset_ret;
			size_ret -=offset_ret;
			ret =(Vector2 *)js_malloc(ctx,size_ret);
			memcpy((void *)ret,(const void *)ret,size_ret);
			JS_FreeValuePtr(ctx,&da_ret);
		}else if(JS_IsArrayBuffer(src)){
			int64_t size_ret;
	...
	static Vector3 * js_getVector3_arr_arg1(JSContext * ctx,JSValue src,bool * error,int size0){
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			if(JS_GetClassID(src0)==js_Vector3_class_id){
				...
				if(size_ret<size0*3){
					JS_ThrowTypeError(ctx,(const char *)"src too short (size0*3)");
					error[0]=(bool)1;
					return NULL;
				}
				size_ret -=size_ret%3;
			...
			size_t size_ret;
			JSValue da_ret=JS_GetTypedArrayBuffer(ctx,src,&offset_ret,&size_ret,NULL);
			ret =(Vector3 *)JS_GetArrayBuffer(ctx,&size_ret,da_ret);
			ret +=offset_ret;
			size_ret -=offset_ret;
			ret =(Vector3 *)js_malloc(ctx,size_ret);
			memcpy((void *)ret,(const void *)ret,size_ret);
			JS_FreeValuePtr(ctx,&da_ret);
		}else if(JS_IsArrayBuffer(src)){
			int64_t size_ret;
	...
	static Vector4 * js_getVector4_arr_arg1(JSContext * ctx,JSValue src,bool * error,int size0){
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			if(JS_GetClassID(src0)==js_Vector4_class_id){
				...
				if(size_ret<size0*4){
					JS_ThrowTypeError(ctx,(const char *)"src too short (size0*4)");
					error[0]=(bool)1;
					return NULL;
				}
				size_ret -=size_ret%4;
			...
			size_t size_ret;
			JSValue da_ret=JS_GetTypedArrayBuffer(ctx,src,&offset_ret,&size_ret,NULL);
			ret =(Vector4 *)JS_GetArrayBuffer(ctx,&size_ret,da_ret);
			ret +=offset_ret;
			size_ret -=offset_ret;
			ret =(Vector4 *)js_malloc(ctx,size_ret);
			memcpy((void *)ret,(const void *)ret,size_ret);
			JS_FreeValuePtr(ctx,&da_ret);
		}else if(JS_IsArrayBuffer(src)){
			int64_t size_ret;
	...
	static Camera js_getCamera(JSContext * ctx,JSValue src,bool * error){
		Camera ret;
		if(JS_GetClassID(src)==js_Camera3D_class_id){
			ret =*(Camera *)JS_GetOpaque(src,js_Camera3D_class_id);
		}else{
	...
	static AutomationEventList js_getAutomationEventList(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_AutomationEventList_class_id){
			ret =*(AutomationEventList *)JS_GetOpaque(src,js_AutomationEventList_class_id);
		}else{
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			for(i=0;i<size_ret;i++){
				...
				if(JS_GetClassID(src0)==js_AutomationEventList_class_id){
					ret[i] =*(AutomationEventList *)JS_GetOpaque(src0,js_AutomationEventList_class_id);
				}else{
	...
	static Camera * js_getCamera_ptr(JSContext * ctx,JSValue src,bool * error){
		...
		if(js_IsArrayLength(ctx,src,(int64_t)1)){
			...
			if(JS_GetClassID(src0)==js_Camera3D_class_id){
				ret =(Camera *)JS_GetOpaque(src0,js_Camera3D_class_id);
			}else{
	...
	static Font js_getFont(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Font_class_id){
			ret =*(Font *)JS_GetOpaque(src,js_Font_class_id);
		}else{
	...
	static Image * js_getImage_ptr(JSContext * ctx,JSValue src,bool * error){
		Image * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(js_IsArrayLength(ctx,src,(int64_t)1)){
			...
			JS_FreeValue(ctx,src0);
			if(JS_GetClassID(src0)==js_Image_class_id){
				ret =(Image *)JS_GetOpaque(src0,js_Image_class_id);
			}else{
				JS_ThrowTypeError(ctx,(const char *)"src0 does not match type Image *");
				error[0]=(bool)1;
				return NULL;
	...
	static Color * js_getColor_arr(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			size_t size_ret;
			JSValue da_ret=JS_GetTypedArrayBuffer(ctx,src,&offset_ret,&size_ret,NULL);
			ret =(Color *)JS_GetArrayBuffer(ctx,&size_ret,da_ret);
			ret +=offset_ret;
			size_ret -=offset_ret;
			ret =(Color *)js_malloc(ctx,size_ret);
			memcpy((void *)ret,(const void *)ret,size_ret);
			JS_FreeValuePtr(ctx,&da_ret);
		}else if(JS_IsArrayBuffer(src)){
			int64_t size_ret;
	...
	static Texture2D * js_getTexture2D_ptr(JSContext * ctx,JSValue src,bool * error){
		Texture2D * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(js_IsArrayLength(ctx,src,(int64_t)1)){
			...
			if(JS_GetClassID(src0)==js_Texture_class_id){
				ret =(Texture2D *)JS_GetOpaque(src0,js_Texture_class_id);
			}else{
	...
	static NPatchInfo js_getNPatchInfo(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_NPatchInfo_class_id){
			ret =*(NPatchInfo *)JS_GetOpaque(src,js_NPatchInfo_class_id);
		}else{
	...
	static wchar_t * js_getwchar_t_arr(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			size_t size_ret;
			JSValue da_ret=JS_GetTypedArrayBuffer(ctx,src,&offset_ret,&size_ret,NULL);
			ret =(wchar_t *)JS_GetArrayBuffer(ctx,&size_ret,da_ret);
			ret +=offset_ret;
			size_ret -=offset_ret;
			ret =(wchar_t *)js_malloc(ctx,size_ret);
			memcpy((void *)ret,(const void *)ret,size_ret);
			JS_FreeValuePtr(ctx,&da_ret);
		}else{
	...
	static Ray js_getRay(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Ray_class_id){
			ret =*(Ray *)JS_GetOpaque(src,js_Ray_class_id);
		}else{
	...
	static Model js_getModel(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Model_class_id){
			ret =*(Model *)JS_GetOpaque(src,js_Model_class_id);
		}else{
	...
	static BoundingBox js_getBoundingBox(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_BoundingBox_class_id){
			ret =*(BoundingBox *)JS_GetOpaque(src,js_BoundingBox_class_id);
		}else{
	...
	static Mesh * js_getMesh_ptr(JSContext * ctx,JSValue src,bool * error){
		Mesh * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(js_IsArrayLength(ctx,src,(int64_t)1)){
			...
			JS_FreeValue(ctx,src0);
			if(JS_GetClassID(src0)==js_Mesh_class_id){
				ret =(Mesh *)JS_GetOpaque(src0,js_Mesh_class_id);
			}else{
				JS_ThrowTypeError(ctx,(const char *)"src0 does not match type Mesh *");
				error[0]=(bool)1;
				return NULL;
	...
	static Material * js_getMaterial_ptr(JSContext * ctx,JSValue src,bool * error){
		Material * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(js_IsArrayLength(ctx,src,(int64_t)1)){
			...
			JS_FreeValue(ctx,src0);
			if(JS_GetClassID(src0)==js_Material_class_id){
				ret =(Material *)JS_GetOpaque(src0,js_Material_class_id);
			}else{
				JS_ThrowTypeError(ctx,(const char *)"src0 does not match type Material *");
				error[0]=(bool)1;
				return NULL;
	...
	static Model * js_getModel_ptr(JSContext * ctx,JSValue src,bool * error){
		Model * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(js_IsArrayLength(ctx,src,(int64_t)1)){
			...
			if(JS_GetClassID(src0)==js_Model_class_id){
				ret =(Model *)JS_GetOpaque(src0,js_Model_class_id);
			}else{
	...
	static ModelAnimation js_getModelAnimation(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_ModelAnimation_class_id){
			ret =*(ModelAnimation *)JS_GetOpaque(src,js_ModelAnimation_class_id);
		}else{
		...
		if(JS_IsNull(src)||JS_IsUndefined(src)){
			...
			for(i=0;i<size_ret;i++){
				...
				if(JS_GetClassID(src0)==js_ModelAnimation_class_id){
					ret[i] =*(ModelAnimation *)JS_GetOpaque(src0,js_ModelAnimation_class_id);
				}else{
	...
	static Wave js_getWave(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Wave_class_id){
			ret =*(Wave *)JS_GetOpaque(src,js_Wave_class_id);
		}else{
	...
	static Sound js_getSound(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Sound_class_id){
			ret =*(Sound *)JS_GetOpaque(src,js_Sound_class_id);
		}else{
	...
	static Wave * js_getWave_ptr(JSContext * ctx,JSValue src,bool * error){
		Wave * ret;
		bool is_arrayProxy=(bool)0;
		if(JS_GetClassID(src)==js_ArrayProxy_class_id){
			is_arrayProxy =(bool)1;
		...
		if(js_IsArrayLength(ctx,src,(int64_t)1)){
			...
			if(JS_GetClassID(src0)==js_Wave_class_id){
				ret =(Wave *)JS_GetOpaque(src0,js_Wave_class_id);
			}else{
	...
	static Music js_getMusic(JSContext * ctx,JSValue src,bool * error){
		...
		if(JS_GetClassID(src)==js_Music_class_id){
			ret =*(Music *)JS_GetOpaque(src,js_Music_class_id);
		}else{
	...
	static JSValue js_Font_set_recs(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		Font * ptr=(Font *)JS_GetOpaque2(ctx,this_val,js_Font_class_id);
		Rectangle * value=js_getRectangle_arr(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_Font_set_glyphs(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		Font * ptr=(Font *)JS_GetOpaque2(ctx,this_val,js_Font_class_id);
		GlyphInfo * value=js_getGlyphInfo_arr(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_Mesh_set_indices(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		Mesh * ptr=(Mesh *)JS_GetOpaque2(ctx,this_val,js_Mesh_class_id);
		unsigned short * value=js_getunsignedshort_arr(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_Mesh_set_boneMatrices(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		Mesh * ptr=(Mesh *)JS_GetOpaque2(ctx,this_val,js_Mesh_class_id);
		Matrix * value=js_getMatrix_arr(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_Shader_set_locs(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		Shader * ptr=(Shader *)JS_GetOpaque2(ctx,this_val,js_Shader_class_id);
		int * value=js_getint_arr(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_Material_set_maps(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		Material * ptr=(Material *)JS_GetOpaque2(ctx,this_val,js_Material_class_id);
		MaterialMap * value=js_getMaterialMap_arr(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_Material_set_params(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		Material * ptr=(Material *)JS_GetOpaque2(ctx,this_val,js_Material_class_id);
		float * value=js_getfloat_arr4(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_BoneInfo_set_name(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		BoneInfo * ptr=(BoneInfo *)JS_GetOpaque2(ctx,this_val,js_BoneInfo_class_id);
		char * value=js_getchar_arr32(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_Model_set_meshes(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		Model * ptr=(Model *)JS_GetOpaque2(ctx,this_val,js_Model_class_id);
		Mesh * value=js_getMesh_arr(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_Model_set_materials(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		Model * ptr=(Model *)JS_GetOpaque2(ctx,this_val,js_Model_class_id);
		Material * value=js_getMaterial_arr(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_Model_set_bones(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		Model * ptr=(Model *)JS_GetOpaque2(ctx,this_val,js_Model_class_id);
		BoneInfo * value=js_getBoneInfo_arr(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_Model_set_bindPose(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		Model * ptr=(Model *)JS_GetOpaque2(ctx,this_val,js_Model_class_id);
		Transform * value=js_getTransform_arr(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_ModelAnimation_framePoses_values(JSContext * ctx,void * ptr_u,int property,bool as_sting){
		...
		for(i=0;i<ptr[0].frameCount;i++){
			JSValue js_ret=JS_NewArray(ctx);
	...
	static int js_ModelAnimation_framePoses_set(JSContext * ctx,void * ptr_u,JSValue set_to,int property,bool as_sting){
		...
		if(as_sting==true){
			...
			bool error=(bool)0;
			Transform * ret=js_getTransform_arr(ctx,set_to,&error);
			if(error==1)return 0;
	...
	static JSValue js_ModelAnimation_set_framePoses(JSContext * ctx,JSValue this_val,JSValue v){
		...
		Transform * * value=js_getTransform_arr_arr(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_VrStereoConfig_set_projection(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		VrStereoConfig * ptr=(VrStereoConfig *)JS_GetOpaque2(ctx,this_val,js_VrStereoConfig_class_id);
		Matrix * value=js_getMatrix_arr2(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_VrStereoConfig_set_leftLensCenter(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		VrStereoConfig * ptr=(VrStereoConfig *)JS_GetOpaque2(ctx,this_val,js_VrStereoConfig_class_id);
		float * value=js_getfloat_arr2(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_FilePathList_paths_values(JSContext * ctx,void * ptr_u,int property,bool as_sting){
		...
		for(i=0;i<ptr[0].count;i++){
			JSValue js_ret=JS_NewString(ctx,(const char *)ptr[0].paths[i]);
			JS_DefinePropertyValueUint32(ctx,ret,(uint32_t)i,js_ret,JS_PROP_C_W_E);
		}
		if(as_sting==true){
			ret =JS_JSONStringify(ctx,ret,JS_UNDEFINED,JS_UNDEFINED);
	...
	static JSValue js_FilePathList_set_paths(JSContext * ctx,JSValue this_val,JSValue v){
		...
		memoryNode * memoryHead=(memoryNode *)calloc((size_t)1,sizeof(memoryNode));
		memoryNode * memoryCurrent=memoryHead;
		char * * value=js_getchar_arr_arr(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_AutomationEvent_set_params(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		AutomationEvent * ptr=(AutomationEvent *)JS_GetOpaque2(ctx,this_val,js_AutomationEvent_class_id);
		int * value=js_getint_arr4(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_AutomationEventList_set_events(JSContext * ctx,JSValue this_val,JSValue v){
		bool error=(bool)0;
		AutomationEventList * ptr=(AutomationEventList *)JS_GetOpaque2(ctx,this_val,js_AutomationEventList_class_id);
		AutomationEvent * value=js_getAutomationEvent_arr(ctx,v,&error);
		if(error==1)return JS_EXCEPTION;
	...
	static unsigned char * callback_LoadFileDataCallback(const char * fileName,int dataSize[1]){
		...
		dataSize =js_getint_ptr(ctx,js1,&error);
	...
	static JSValue js_Font_constructor(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		if(error==1)return JS_EXCEPTION;
		Rectangle * recs=js_getRectangle_arr(ctx,argv[4],&error);
		if(error==1)return JS_EXCEPTION;
		GlyphInfo * glyphs=js_getGlyphInfo_arr(ctx,argv[5],&error);
		if(error==1)return JS_EXCEPTION;
		Font _struct={
			baseSize,
			glyphCount,
	...
	static JSValue js_Mesh_constructor(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		if(error==1)return JS_EXCEPTION;
		float * vertices=js_getfloat_arr(ctx,argv[2],&error);
		if(error==1)return JS_EXCEPTION;
		float * texcoords=js_getfloat_arr(ctx,argv[3],&error);
		if(error==1)return JS_EXCEPTION;
		float * texcoords2=js_getfloat_arr(ctx,argv[4],&error);
		if(error==1)return JS_EXCEPTION;
		float * normals=js_getfloat_arr(ctx,argv[5],&error);
		if(error==1)return JS_EXCEPTION;
		float * tangents=js_getfloat_arr(ctx,argv[6],&error);
		if(error==1)return JS_EXCEPTION;
		unsigned char * colors=js_getunsignedchar_arr(ctx,argv[7],&error);
		if(error==1)return JS_EXCEPTION;
		unsigned short * indices=js_getunsignedshort_arr(ctx,argv[8],&error);
		if(error==1)return JS_EXCEPTION;
		float * animVertices=js_getfloat_arr(ctx,argv[9],&error);
		if(error==1)return JS_EXCEPTION;
		float * animNormals=js_getfloat_arr(ctx,argv[10],&error);
		if(error==1)return JS_EXCEPTION;
		unsigned char * boneIds=js_getunsignedchar_arr(ctx,argv[11],&error);
		if(error==1)return JS_EXCEPTION;
		float * boneWeights=js_getfloat_arr(ctx,argv[12],&error);
		if(error==1)return JS_EXCEPTION;
		Matrix * boneMatrices=js_getMatrix_arr(ctx,argv[13],&error);
		if(error==1)return JS_EXCEPTION;
		int boneCount=js_getint(ctx,argv[14],&error);
		if(error==1)return JS_EXCEPTION;
		unsigned int vaoId=js_getunsignedint(ctx,argv[15],&error);
		if(error==1)return JS_EXCEPTION;
		unsigned int * vboId=js_getunsignedint_arr(ctx,argv[16],&error);
		if(error==1)return JS_EXCEPTION;
		Mesh _struct={
			vertexCount,
			triangleCount,
	...
	static JSValue js_Material_constructor(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		if(error==1)return JS_EXCEPTION;
		MaterialMap * maps=js_getMaterialMap_arr(ctx,argv[1],&error);
		if(error==1)return JS_EXCEPTION;
		float * params=js_getfloat_arr4(ctx,argv[2],&error);
		if(error==1)return JS_EXCEPTION;
		Material _struct={
			shader,
			maps,
	...
	static JSValue js_BoneInfo_constructor(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		bool error=(bool)0;
		char * name=js_getchar_arr32(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_Model_constructor(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		if(error==1)return JS_EXCEPTION;
		Mesh * meshes=js_getMesh_arr(ctx,argv[3],&error);
		if(error==1)return JS_EXCEPTION;
		Material * materials=js_getMaterial_arr(ctx,argv[4],&error);
		if(error==1)return JS_EXCEPTION;
		int * meshMaterial=js_getint_arr(ctx,argv[5],&error);
		if(error==1)return JS_EXCEPTION;
		int boneCount=js_getint(ctx,argv[6],&error);
		if(error==1)return JS_EXCEPTION;
		BoneInfo * bones=js_getBoneInfo_arr(ctx,argv[7],&error);
		if(error==1)return JS_EXCEPTION;
		Transform * bindPose=js_getTransform_arr(ctx,argv[8],&error);
		if(error==1)return JS_EXCEPTION;
		Model _struct={
			transform,
			meshCount,
	...
	static JSValue js_ModelAnimation_constructor(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		if(error==1)return JS_EXCEPTION;
		BoneInfo * bones=js_getBoneInfo_arr(ctx,argv[2],&error);
		if(error==1)return JS_EXCEPTION;
		Transform * * framePoses=js_getTransform_arr_arr(ctx,argv[3],&error);
		if(error==1)return JS_EXCEPTION;
		char * name=js_getchar_arr32(ctx,argv[4],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_AudioStream_constructor(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		bool error=(bool)0;
		rAudioBuffer * buffer=js_getrAudioBuffer_ptr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
		rAudioProcessor * processor=js_getrAudioProcessor_ptr(ctx,argv[1],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_VrDeviceInfo_constructor(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		if(error==1)return JS_EXCEPTION;
		float * lensDistortionValues=js_getfloat_arr4(ctx,argv[7],&error);
		if(error==1)return JS_EXCEPTION;
		float * chromaAbCorrection=js_getfloat_arr4(ctx,argv[8],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_VrStereoConfig_constructor(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		bool error=(bool)0;
		Matrix * projection=js_getMatrix_arr2(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
		Matrix * viewOffset=js_getMatrix_arr2(ctx,argv[1],&error);
		if(error==1)return JS_EXCEPTION;
		float * leftLensCenter=js_getfloat_arr2(ctx,argv[2],&error);
		if(error==1)return JS_EXCEPTION;
		float * rightLensCenter=js_getfloat_arr2(ctx,argv[3],&error);
		if(error==1)return JS_EXCEPTION;
		float * leftScreenCenter=js_getfloat_arr2(ctx,argv[4],&error);
		if(error==1)return JS_EXCEPTION;
		float * rightScreenCenter=js_getfloat_arr2(ctx,argv[5],&error);
		if(error==1)return JS_EXCEPTION;
		float * scale=js_getfloat_arr2(ctx,argv[6],&error);
		if(error==1)return JS_EXCEPTION;
		float * scaleIn=js_getfloat_arr2(ctx,argv[7],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_FilePathList_constructor(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		if(error==1)return JS_EXCEPTION;
		char * * paths=js_getchar_arr_arr(ctx,argv[2],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_AutomationEvent_constructor(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		if(error==1)return JS_EXCEPTION;
		int * params=js_getint_arr4(ctx,argv[2],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_AutomationEventList_constructor(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		unsigned int count=js_getunsignedint(ctx,argv[1],&error);
		if(error==1)return JS_EXCEPTION;
		AutomationEvent * events=js_getAutomationEvent_arr(ctx,argv[2],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_LoadShader(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		memoryNode * memoryHead=(memoryNode *)calloc((size_t)1,sizeof(memoryNode));
		memoryNode * memoryCurrent=memoryHead;
		char * vsFileName=js_getchar_arr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_SetShaderValue(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		if(uniformType==SHADER_UNIFORM_FLOAT){
			float * val=js_getfloat_ptr(ctx,argv[2],&error);
			if(error==1)return JS_EXCEPTION;
			value=((void *)val);
		}else if(uniformType==SHADER_UNIFORM_VEC2){
			Vector2 * val=js_getVector2_ptr(ctx,argv[2],&error);
			if(error==1)return JS_EXCEPTION;
			value=((void *)val);
		}else if(uniformType==SHADER_UNIFORM_VEC3){
			Vector3 * val=js_getVector3_ptr(ctx,argv[2],&error);
			if(error==1)return JS_EXCEPTION;
			value=((void *)val);
		}else if(uniformType==SHADER_UNIFORM_VEC4){
			Vector4 * val=js_getVector4_ptr(ctx,argv[2],&error);
			if(error==1)return JS_EXCEPTION;
			value=((void *)val);
		}else if(uniformType==SHADER_UNIFORM_INT||uniformType==SHADER_UNIFORM_SAMPLER2D){
			int * val=js_getint_ptr(ctx,argv[2],&error);
			if(error==1)return JS_EXCEPTION;
			value=((void *)val);
			...
			unsigned int * val=js_getunsignedint_ptr(ctx,argv[2],&error);
			if(error==1)return JS_EXCEPTION;
			value=((void *)val);
	...
	static JSValue js_LoadFileData(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		char * fileName=js_getchar_arr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
		int * dataSize=js_getint_ptr(ctx,argv[1],&error);
		if(error==1)return JS_EXCEPTION;
		unsigned char * returnVal=(unsigned char *)LoadFileData((const char *)fileName,dataSize);
		if(JS_IsArray(argv[1])==1){
			JSValue js_argv10=JS_NewInt32(ctx,(int32_t)((long)dataSize[0]));
			JS_DefinePropertyValueUint32(ctx,argv[1],(uint32_t)0,js_argv10,JS_PROP_C_W_E);
		}
		JSValue ret=JS_NewArray(ctx);
		int i;
		for(i=0;i<dataSize[0];i++){
			JSValue js_ret=JS_NewUint32(ctx,(uint32_t)((unsigned long)returnVal[i]));
			JS_DefinePropertyValueUint32(ctx,ret,(uint32_t)i,js_ret,JS_PROP_C_W_E);
		}
	...
	static JSValue js_LoadDirectoryFilesEx(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		if(error==1)return JS_EXCEPTION;
		char * filter=js_getchar_arr(ctx,argv[1],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_CheckCollisionLines(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		if(error==1)return JS_EXCEPTION;
		Vector2 * collisionPoint=js_getVector2_ptr(ctx,argv[4],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_LoadImageAnim(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		char * fileName=js_getchar_arr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
		int * frames=js_getint_ptr(ctx,argv[1],&error);
		if(error==1)return JS_EXCEPTION;
		Image returnVal=LoadImageAnim((const char *)fileName,frames);
		if(JS_IsArray(argv[1])==1){
			JSValue js_argv10=JS_NewInt32(ctx,(int32_t)((long)frames[0]));
			JS_DefinePropertyValueUint32(ctx,argv[1],(uint32_t)0,js_argv10,JS_PROP_C_W_E);
		}
		Image * ptr_ret=(Image *)js_malloc(ctx,sizeof(Image));
		ptr_ret[0]=returnVal;
	...
	static JSValue js_LoadImageAnimFromMemory(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		int dataSize=js_getint(ctx,argv[2],&error);
		if(error==1)return JS_EXCEPTION;
		int * frames=js_getint_ptr(ctx,argv[3],&error);
		if(error==1)return JS_EXCEPTION;
		...
		if(JS_IsArray(argv[3])==1){
			JSValue js_argv30=JS_NewInt32(ctx,(int32_t)((long)frames[0]));
	...
	static JSValue js_ExportImageToMemory(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		if(error==1)return JS_EXCEPTION;
		int * fileSize=js_getint_ptr(ctx,argv[2],&error);
		if(error==1)return JS_EXCEPTION;
		char * returnVal=ExportImageToMemory(image,(const char *)fileType,fileSize);
		if(JS_IsArray(argv[2])==1){
			JSValue js_argv20=JS_NewInt32(ctx,(int32_t)((long)fileSize[0]));
			JS_DefinePropertyValueUint32(ctx,argv[2],(uint32_t)0,js_argv20,JS_PROP_C_W_E);
		}
		JSValue ret=JS_NewString(ctx,(const char *)returnVal);
		return ret;
	...
	static JSValue js_ImageFormat(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		bool error=(bool)0;
		Image * image=js_getImage_ptr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_ImageClearBackground(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		bool error=(bool)0;
		Image * dst=js_getImage_ptr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
		Color color=js_getColor(ctx,argv[1],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_GenTextureMipmaps(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		bool error=(bool)0;
		Texture2D * texture=js_getTexture2D_ptr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_LoadFontEx(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		int fontSize=js_getint(ctx,argv[1],&error);
		if(error==1)return JS_EXCEPTION;
		int * codepoints=js_getint_arr(ctx,argv[2],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_LoadFontData(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		if(error==1)return JS_EXCEPTION;
		int * codepoints=js_getint_arr(ctx,argv[3],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_LoadCodepoints(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		char * text=js_getchar_arr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
		int * count=js_getint_ptr(ctx,argv[1],&error);
		if(error==1)return JS_EXCEPTION;
		int * returnVal=LoadCodepoints((const char *)text,count);
		if(JS_IsArray(argv[1])==1){
			JSValue js_argv10=JS_NewInt32(ctx,(int32_t)((long)count[0]));
			JS_DefinePropertyValueUint32(ctx,argv[1],(uint32_t)0,js_argv10,JS_PROP_C_W_E);
		}
		JSValue ret=JS_NewArray(ctx);
		int i;
	...
	static JSValue js_GetCodepoint(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		char * text=js_getchar_arr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
		int * codepointSize=js_getint_ptr(ctx,argv[1],&error);
		if(error==1)return JS_EXCEPTION;
		int returnVal=GetCodepoint((const char *)text,codepointSize);
		if(JS_IsArray(argv[1])==1){
			JSValue js_argv10=JS_NewInt32(ctx,(int32_t)((long)codepointSize[0]));
			JS_DefinePropertyValueUint32(ctx,argv[1],(uint32_t)0,js_argv10,JS_PROP_C_W_E);
		}
		JSValue ret=JS_NewInt32(ctx,(int32_t)((long)returnVal));
		return ret;
		...
		for(i=0;i<formatlen;i++){
			if(format[i]!='%'){
				...
				if(har=='d'||har=='i'){
					...
					int a=js_getint(ctx,argv[c],&error);
					if(error==1)return JS_EXCEPTION;
					if(firsth==lasth){
						char_ptr =asnprintf(ctx,char_ptr,&char_ptrlen,(const char *)subformat,n,w,p,(int)a);
					}else{
	...
	static JSValue js_TextReplace(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		char * text=js_getchar_arr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
		char * replace=js_getchar_arr(ctx,argv[1],&error);
		if(error==1)return JS_EXCEPTION;
		char * by=js_getchar_arr(ctx,argv[2],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_TextSplit(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		if(error==1)return JS_EXCEPTION;
		int * count=js_getint_ptr(ctx,argv[2],&error);
		if(error==1)return JS_EXCEPTION;
		char * * returnVal=TextSplit((const char *)text,delimiter,count);
		if(JS_IsArray(argv[2])==1){
			JSValue js_argv20=JS_NewInt32(ctx,(int32_t)((long)count[0]));
			JS_DefinePropertyValueUint32(ctx,argv[2],(uint32_t)0,js_argv20,JS_PROP_C_W_E);
		}
		JSValue ret=JS_NewArray(ctx);
		char * * sizeref_ret=returnVal;
	...
	static JSValue js_TextAppend(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		if(error==1)return JS_EXCEPTION;
		int * position=js_getint_ptr(ctx,argv[2],&error);
		if(error==1)return JS_EXCEPTION;
		TextAppend(text,(const char *)append,position);
		if(JS_IsArray(argv[2])==1){
			JSValue js_argv20=JS_NewInt32(ctx,(int32_t)((long)position[0]));
			JS_DefinePropertyValueUint32(ctx,argv[2],(uint32_t)0,js_argv20,JS_PROP_C_W_E);
		}
		memoryClear(ctx,memoryHead);
		return JS_UNDEFINED;
	...
	static JSValue js_TextFindIndex(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		char * text=js_getchar_arr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
		char * find=js_getchar_arr(ctx,argv[1],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_UploadMesh(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		bool error=(bool)0;
		Mesh * mesh=js_getMesh_ptr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_SetMaterialTexture(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		bool error=(bool)0;
		Material * material=js_getMaterial_ptr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_SetModelMeshMaterial(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		bool error=(bool)0;
		Model * model=js_getModel_ptr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_LoadModelAnimations(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		char * fileName=js_getchar_arr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
		int * animCount=js_getint_ptr(ctx,argv[1],&error);
		if(error==1)return JS_EXCEPTION;
		ModelAnimation * returnVal=LoadModelAnimations((const char *)fileName,animCount);
		if(JS_IsArray(argv[1])==1){
			JSValue js_argv10=JS_NewInt32(ctx,(int32_t)((long)animCount[0]));
			JS_DefinePropertyValueUint32(ctx,argv[1],(uint32_t)0,js_argv10,JS_PROP_C_W_E);
		}
		JSValue ret=JS_NewArray(ctx);
		int i;
		for(i=0;i<animCount[0];i++){
	...
	static JSValue js_WaveCrop(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		bool error=(bool)0;
		Wave * wave=js_getWave_ptr(ctx,argv[0],&error);
		if(error==1)return JS_EXCEPTION;
	...
	static JSValue js_DetachAudioMixedProcessor(JSContext * ctx,JSValue this_val,int argc,JSValue * argv){
		...
		for(i=0;i<AudioCallback_size;i++){
			if(JS_IsEqual(AudioCallback_arr[i].ctx,AudioCallback_arr[i].func_obj,argv[0])){
				...
				int i0;
				for(i0=i;i0<AudioCallback_size-1;i0++){
