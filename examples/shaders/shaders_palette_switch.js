...
import {BeginDrawing, BeginShaderMode, ClearBackground, CloseWindow, Color, DARKBLUE, DrawFPS, DrawRectangle,
    DrawText,
    EndDrawing,
    EndShaderMode,
    GetScreenWidth, GetShaderLocation, InitWindow, IsKeyPressed,
    KEY_LEFT, KEY_RIGHT, LoadShader,
    RAYWHITE, RED, SHADER_UNIFORM_IVEC3, SetShaderValueV, SetTargetFPS, TextFormat, UnloadShader, WindowShouldClose } from 'rayjs:raylib';
...
//------------------------------------------------------------------------------------
{
    ...
    let shader = LoadShader(null, TextFormat("resources/shaders/glsl%i/palette_switch.fs", GLSL_VERSION));

    // Get variable (uniform) location on the shader to connect with the program
    // NOTE: If uniform variable could not be found in the shader, function returns -1
    const paletteLoc = GetShaderLocation(shader, "palette");

    let currentPalette = 0;
    const lineHeight = screenHeight/COLORS_PER_PALETTE;
