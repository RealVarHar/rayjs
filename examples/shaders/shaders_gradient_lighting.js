...
import {BeginDrawing,
    BeginMode3D, CAMERA_ORBITAL, CAMERA_PERSPECTIVE, Camera3D, ClearBackground, CloseWindow, ColorAlpha, DARKBLUE,
    DARKGRAY,
    DrawFPS,
    DrawGrid, DrawModel,
    DrawSphereEx, DrawSphereWires, DrawText, DrawTexturePro, EndDrawing, EndMode3D, FLAG_MSAA_4X_HINT,
    GenImageColor,
    GenImageGradientLinear,
    GenMeshPlane, GetShaderLocation, ImageDraw, InitWindow,
    IsKeyPressed, KEY_Y, LoadMaterialDefault, LoadModel, LoadModelFromMesh,
    LoadShader,
    LoadTextureFromImage, MATERIAL_MAP_DIFFUSE, PURPLE, RAYWHITE, Rectangle,
    SHADER_UNIFORM_VEC3,
    SHADER_UNIFORM_VEC4, SetConfigFlags, SetMaterialTexture, SetShaderValue,
    SetTargetFPS, UnloadImage, UnloadModel, UnloadShader, UpdateCamera, Vector3, WHITE, WindowShouldClose, YELLOW } from 'rayjs:raylib';
{
    ...
    ********************************************************************************************/
    ...
    // Create lights
    const light = rlights.CreateLight(rlights.LIGHT_POINT, new Vector3(-2,1,-2), raymath.Vector3Zero(), WHITE, shader)
    light.attenuation *= 2
    ...
    while (!WindowShouldClose()) {      // Detect window close button or ESC key
        ...
        BeginDrawing();
            ...
            DrawTexturePro(texture, new Rectangle(0,0,256,1), new Rectangle(0,0,screenWidth, 32), raymath.Vector2Zero(), 0, WHITE)
