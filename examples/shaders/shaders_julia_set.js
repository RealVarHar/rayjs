...
import {BLACK,
    BeginDrawing,
    BeginShaderMode, BeginTextureMode,
    ClearBackground,
    CloseWindow,
    DrawRectangle,
    DrawText,
    ...
    EndDrawing,
    EndShaderMode,
    EndTextureMode, GetFrameTime, GetMousePosition, GetScreenHeight, GetScreenWidth, GetShaderLocation, InitWindow, IsKeyPressed,
    IsMouseButtonDown,
    KEY_F1,
    KEY_FIVE,
    KEY_FOUR,
    KEY_LEFT,
    KEY_ONE, KEY_R, KEY_RIGHT, KEY_SIX, KEY_SPACE, KEY_THREE, KEY_TWO, LoadRenderTexture, LoadShader,
    MOUSE_BUTTON_LEFT,
    MOUSE_BUTTON_RIGHT,
    RAYWHITE,
    SHADER_UNIFORM_FLOAT,
    SHADER_UNIFORM_VEC2,
    SetShaderValue, SetTargetFPS, TextFormat,
    UnloadRenderTexture,
    UnloadShader,
    Vector2,
...
const offsetSpeedMul = 2;

const startingZoom = 0.75;
...
//------------------------------------------------------------------------------------
{
    ...
    let c = [ pointsOfInterest[0][0], pointsOfInterest[0][1] ];
    ...
    let zoomLoc = GetShaderLocation(shader, "zoom");
    let offsetLoc = GetShaderLocation(shader, "offset");
    ...
    let incrementSpeed = 0;             // Multiplier of speed to change c value
    let showControls = true;           // Show controls
    ...
    while (!WindowShouldClose()) {       // Detect window close button or ESC key
        ...
        if (IsMouseButtonDown(MOUSE_BUTTON_LEFT) || IsMouseButtonDown(MOUSE_BUTTON_RIGHT)) {
            ...
            zoom *= IsMouseButtonDown(MOUSE_BUTTON_LEFT)? zoomSpeed : 1/zoomSpeed;
        ...
        const dc = GetFrameTime()*incrementSpeed*0.0005;
        c[0] += dc;
        c[1] += dc;
        SetShaderValue(shader, cLoc, c, SHADER_UNIFORM_VEC2);
        //----------------------------------------------------------------------------------
        ...
        BeginDrawing();
            ...
            BeginShaderMode(shader);
                ...
                DrawTextureEx(target.texture, new Vector2( 0, 0 ), 0, 1, WHITE);
            EndShaderMode();
