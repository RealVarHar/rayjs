...
const SUNNY_STYLE_PROPS_COUNT = 33;

// Custom style name: Sunny
const sunnyStyleProps = [
new GuiStyleProp(0, 0, 0x9c760aff),    // DEFAULT_BORDER_COLOR_NORMAL
new GuiStyleProp(0, 1, 0x594006ff),    // DEFAULT_BASE_COLOR_NORMAL
new GuiStyleProp(0, 2, 0xf6d519ff),    // DEFAULT_TEXT_COLOR_NORMAL
new GuiStyleProp(0, 3, 0xf6ee89ff),    // DEFAULT_BORDER_COLOR_FOCUSED
new GuiStyleProp(0, 4, 0xf5f3d1ff),    // DEFAULT_BASE_COLOR_FOCUSED
new GuiStyleProp(0, 5, 0xf4cd19ff),    // DEFAULT_TEXT_COLOR_FOCUSED
new GuiStyleProp(0, 6, 0xf7e580ff),    // DEFAULT_BORDER_COLOR_PRESSED
new GuiStyleProp(0, 7, 0xf7f2c1ff),    // DEFAULT_BASE_COLOR_PRESSED
new GuiStyleProp(0, 8, 0x52470aff),    // DEFAULT_TEXT_COLOR_PRESSED
new GuiStyleProp(0, 9, 0xc0be92ff),    // DEFAULT_BORDER_COLOR_DISABLED
new GuiStyleProp(0, 10,0xd3d3a1ff),    // DEFAULT_BASE_COLOR_DISABLED
new GuiStyleProp(0, 11,0xbcbc89ff),    // DEFAULT_TEXT_COLOR_DISABLED
new GuiStyleProp(0, 16,0x00000010),    // DEFAULT_TEXT_SIZE
new GuiStyleProp(0, 17,0x00000000),    // DEFAULT_TEXT_SPACING
new GuiStyleProp(0, 18,0x725706ff),    // DEFAULT_LINE_COLOR
new GuiStyleProp(0, 19,0xf0be4bff),    // DEFAULT_BACKGROUND_COLOR
new GuiStyleProp(0, 20,0x00000018),    // DEFAULT_TEXT_LINE_SPACING
new GuiStyleProp(1, 2, 0x504506ff),    // LABEL_TEXT_COLOR_NORMAL
new GuiStyleProp(1, 5, 0xfdeb9bff),    // LABEL_TEXT_COLOR_FOCUSED
new GuiStyleProp(1, 8, 0xf5e8a4ff),    // LABEL_TEXT_COLOR_PRESSED
new GuiStyleProp(2, 2, 0xebc21fff),    // BUTTON_TEXT_COLOR_NORMAL
new GuiStyleProp(3, 2, 0xebc21fff),    // TOGGLE_TEXT_COLOR_NORMAL
new GuiStyleProp(4, 2, 0x81700fff),    // SLIDER_TEXT_COLOR_NORMAL
new GuiStyleProp(4, 5, 0xf4e49aff),    // SLIDER_TEXT_COLOR_FOCUSED
new GuiStyleProp(7, 2, 0xebc21fff),    // COMBOBOX_TEXT_COLOR_NORMAL
new GuiStyleProp(8, 2, 0xefd87bff),    // DROPDOWNBOX_TEXT_COLOR_NORMAL
new GuiStyleProp(8, 5, 0xd4b219ff),    // DROPDOWNBOX_TEXT_COLOR_FOCUSED
new GuiStyleProp(9, 2, 0x7a680bff),    // TEXTBOX_TEXT_COLOR_NORMAL
new GuiStyleProp(9, 5, 0xad931fff),    // TEXTBOX_TEXT_COLOR_FOCUSED
new GuiStyleProp(10,2, 0x62570eff),    // VALUEBOX_TEXT_COLOR_NORMAL
new GuiStyleProp(10,5, 0xf2df88ff),    // VALUEBOX_TEXT_COLOR_FOCUSED
new GuiStyleProp(12,2, 0xf4e798ff),    // LISTVIEW_TEXT_COLOR_NORMAL
new GuiStyleProp(15,2, 0xebc21fff),    // STATUSBAR_TEXT_COLOR_NORMAL
];

// WARNING: This style uses a custom font: "GenericMobileSystemNuevo.ttf" (size: 16, spacing: 0)

const SUNNY_STYLE_FONT_ATLAS_COMP_SIZE = 2462;

// Font atlas image pixels data: DEFLATE compressed
const sunnyFontData = [ 0xed,
...
new Rectangle(16, 4,  2,10),
new Rectangle(26, 4,  5,3 ),
new Rectangle(39, 4,  7,10),
new Rectangle(54, 4,  7,13),
new Rectangle(69, 4,  7,10),
new Rectangle(84, 4,  7,10),
new Rectangle(99, 4,  2,3 ),
new Rectangle(109,4,  3,12),
new Rectangle(120,4,  3,12),
new Rectangle(131,4,  5,6 ),
new Rectangle(144,4,  6,5 ),
new Rectangle(158,4,  2,4 ),
new Rectangle(168,4,  5,1 ),
new Rectangle(181,4,  2,2 ),
new Rectangle(191,4,  4,10),
new Rectangle(203,4,  6,10),
new Rectangle(217,4,  4,10),
new Rectangle(229,4,  6,10),
new Rectangle(243,4,  6,10),
new Rectangle(257,4,  6,10),
new Rectangle(271,4,  6,10),
new Rectangle(285,4,  6,10),
new Rectangle(299,4,  6,10),
new Rectangle(313,4,  6,10),
new Rectangle(327,4,  6,10),
new Rectangle(341,4,  2,6 ),
new Rectangle(351,4,  2,8 ),
new Rectangle(361,4,  7,7 ),
new Rectangle(376,4,  5,3 ),
new Rectangle(389,4,  7,7 ),
new Rectangle(404,4,  6,10),
new Rectangle(418,4,  7,12),
new Rectangle(433,4,  7,10),
new Rectangle(448,4,  7,10),
new Rectangle(463,4,  7,10),
new Rectangle(478,4,  7,10),
new Rectangle(493,4,  7,10),
new Rectangle(4,  28, 7,10),
new Rectangle(19, 28, 7,10),
new Rectangle(34, 28, 7,10),
new Rectangle(49, 28, 2,10),
new Rectangle(59, 28, 5,10),
new Rectangle(72, 28, 7,10),
new Rectangle(87, 28, 6,10),
new Rectangle(101,28, 9,10),
new Rectangle(118,28, 7,10),
new Rectangle(133,28, 7,10),
new Rectangle(148,28, 7,10),
new Rectangle(163,28, 7,12),
new Rectangle(178,28, 7,10),
new Rectangle(193,28, 7,10),
new Rectangle(208,28, 6,10),
new Rectangle(222,28, 7,10),
new Rectangle(237,28, 7,10),
new Rectangle(252,28, 8,10),
new Rectangle(268,28, 7,10),
new Rectangle(283,28, 6,10),
new Rectangle(297,28, 7,10),
new Rectangle(312,28, 4,12),
new Rectangle(324,28, 4,10),
new Rectangle(336,28, 4,12),
new Rectangle(348,28, 6,3 ),
new Rectangle(362,28, 7,1 ),
new Rectangle(377,28, 4,3 ),
new Rectangle(389,28, 6,7 ),
new Rectangle(403,28, 6,10),
new Rectangle(417,28, 6,7 ),
new Rectangle(431,28, 6,10),
new Rectangle(445,28, 6,7 ),
new Rectangle(459,28, 4,10),
new Rectangle(471,28, 6,9 ),
new Rectangle(485,28, 6,10),
new Rectangle(499,28, 2,10),
new Rectangle(4,  52, 5,12),
new Rectangle(17, 52, 6,10),
new Rectangle(31, 52, 3,10),
new Rectangle(42, 52, 8,7 ),
new Rectangle(58, 52, 6,7 ),
new Rectangle(72, 52, 6,7 ),
new Rectangle(86, 52, 6,9 ),
new Rectangle(100,52, 6,9 ),
new Rectangle(114,52, 5,7 ),
new Rectangle(127,52, 6,7 ),
new Rectangle(141,52, 4,10),
new Rectangle(153,52, 6,7 ),
new Rectangle(167,52, 6,7 ),
new Rectangle(181,52, 8,7 ),
new Rectangle(197,52, 6,7 ),
new Rectangle(211,52, 6,9 ),
new Rectangle(225,52, 6,7 ),
new Rectangle(239,52, 5,12),
new Rectangle(252,52, 2,12),
new Rectangle(262,52, 5,12),
new Rectangle(275,52, 7,3 ),
new Rectangle(290,52, 2,9 ),
new Rectangle(300,52, 6,11),
new Rectangle(314,52, 7,10),
new Rectangle(329,52, 7,9 ),
new Rectangle(344,52, 6,10),
new Rectangle(358,52, 7,11),
new Rectangle(373,52, 6,12),
new Rectangle(387,52, 6,10),
new Rectangle(401,52, 7,10),
new Rectangle(416,52, 5,5 ),
new Rectangle(429,52, 7,6 ),
new Rectangle(444,52, 6,3 ),
new Rectangle(458,52, 7,10),
new Rectangle(473,52, 9,10),
new Rectangle(490,52, 4,4 ),
new Rectangle(4,  76, 6,7 ),
new Rectangle(18, 76, 4,5 ),
new Rectangle(30, 76, 4,5 ),
new Rectangle(42, 76, 7,11),
new Rectangle(57, 76, 6,9 ),
new Rectangle(71, 76, 7,12),
new Rectangle(86, 76, 2,2 ),
new Rectangle(96, 76, 6,10),
new Rectangle(110,76, 3,5 ),
new Rectangle(121,76, 4,5 ),
new Rectangle(133,76, 7,6 ),
new Rectangle(148,76, 9,10),
new Rectangle(165,76, 8,7 ),
new Rectangle(181,76, 6,11),
new Rectangle(195,76, 6,11),
new Rectangle(209,76, 7,11),
new Rectangle(224,76, 7,11),
new Rectangle(239,76, 7,11),
new Rectangle(254,76, 7,11),
new Rectangle(269,76, 7,11),
new Rectangle(284,76, 7,11),
new Rectangle(299,76, 9,10),
new Rectangle(316,76, 7,12),
new Rectangle(331,76, 7,11),
new Rectangle(346,76, 7,11),
new Rectangle(361,76, 7,11),
new Rectangle(376,76, 7,11),
new Rectangle(391,76, 3,11),
new Rectangle(402,76, 3,11),
new Rectangle(413,76, 5,11),
new Rectangle(426,76, 5,11),
new Rectangle(439,76, 8,10),
new Rectangle(455,76, 7,11),
new Rectangle(470,76, 7,11),
new Rectangle(485,76, 7,11),
new Rectangle(4,  100,7,11),
new Rectangle(19, 100,7,11),
new Rectangle(34, 100,7,11),
new Rectangle(49, 100,7,7 ),
new Rectangle(64, 100,7,13),
new Rectangle(79, 100,7,11),
new Rectangle(94, 100,7,11),
new Rectangle(109,100,7,11),
new Rectangle(124,100,7,11),
new Rectangle(139,100,6,11),
new Rectangle(153,100,7,10),
new Rectangle(168,100,7,10),
new Rectangle(183,100,6,10),
new Rectangle(197,100,6,10),
new Rectangle(211,100,6,10),
new Rectangle(225,100,6,10),
new Rectangle(239,100,6,10),
new Rectangle(253,100,6,11),
new Rectangle(267,100,8,7 ),
new Rectangle(283,100,6,9 ),
new Rectangle(297,100,6,10),
new Rectangle(311,100,6,10),
new Rectangle(325,100,6,10),
new Rectangle(339,100,6,10),
new Rectangle(353,100,3,10),
new Rectangle(364,100,3,10),
new Rectangle(375,100,5,10),
new Rectangle(388,100,5,10),
new Rectangle(401,100,6,10),
new Rectangle(415,100,6,10),
new Rectangle(429,100,6,10),
new Rectangle(443,100,6,10),
new Rectangle(457,100,6,10),
new Rectangle(471,100,6,10),
new Rectangle(485,100,6,10),
new Rectangle(4,  124,6,7 ),
new Rectangle(18, 124,7,11),
new Rectangle(33, 124,6,10),
new Rectangle(47, 124,6,10),
new Rectangle(61, 124,6,10),
new Rectangle(75, 124,6,10),
new Rectangle(89, 124,6,12),
new Rectangle(103,124,6,12),
new Rectangle(117,124,6,12)
];

// Font glyphs info data
// NOTE: No glyphs.image data provided
const sunnyFontGlyphs = [
new GlyphInfo(32,  0,12,4, new Image()),
new GlyphInfo(33,  0,2, 3, new Image()),
new GlyphInfo(34,  0,2, 6, new Image()),
new GlyphInfo(35,  0,2, 8, new Image()),
new GlyphInfo(36,  0,1, 8, new Image()),
new GlyphInfo(37,  0,2, 8, new Image()),
new GlyphInfo(38,  0,2, 8, new Image()),
new GlyphInfo(39,  0,2, 3, new Image()),
...
new GlyphInfo(45,  0,8, 6, new Image()),
new GlyphInfo(46,  0,10,3, new Image()),
new GlyphInfo(47,  0,2, 5, new Image()),
new GlyphInfo(48,  0,2, 7, new Image()),
new GlyphInfo(49,  0,2, 7, new Image()),
new GlyphInfo(50,  0,2, 7, new Image()),
new GlyphInfo(51,  0,2, 7, new Image()),
new GlyphInfo(52,  0,2, 7, new Image()),
new GlyphInfo(53,  0,2, 7, new Image()),
new GlyphInfo(54,  0,2, 7, new Image()),
new GlyphInfo(55,  0,2, 7, new Image()),
new GlyphInfo(56,  0,2, 7, new Image()),
new GlyphInfo(57,  0,2, 7, new Image()),
new GlyphInfo(58,  0,4, 3, new Image()),
new GlyphInfo(59,  0,4, 3, new Image()),
new GlyphInfo(60,  0,4, 8, new Image()),
new GlyphInfo(61,  0,6, 6, new Image()),
new GlyphInfo(62,  0,4, 8, new Image()),
new GlyphInfo(63,  0,2, 7, new Image()),
new GlyphInfo(64,  0,2, 8, new Image()),
new GlyphInfo(65,  0,2, 8, new Image()),
new GlyphInfo(66,  0,2, 8, new Image()),
new GlyphInfo(67,  0,2, 8, new Image()),
new GlyphInfo(68,  0,2, 8, new Image()),
new GlyphInfo(69,  0,2, 8, new Image()),
new GlyphInfo(70,  0,2, 8, new Image()),
new GlyphInfo(71,  0,2, 8, new Image()),
new GlyphInfo(72,  0,2, 8, new Image()),
new GlyphInfo(73,  0,2, 3, new Image()),
new GlyphInfo(74,  0,2, 6, new Image()),
new GlyphInfo(75,  0,2, 8, new Image()),
new GlyphInfo(76,  0,2, 7, new Image()),
new GlyphInfo(77,  0,2, 10,new Image()),
new GlyphInfo(78,  0,2, 8, new Image()),
new GlyphInfo(79,  0,2, 8, new Image()),
new GlyphInfo(80,  0,2, 8, new Image()),
new GlyphInfo(81,  0,2, 8, new Image()),
new GlyphInfo(82,  0,2, 8, new Image()),
new GlyphInfo(83,  0,2, 8, new Image()),
new GlyphInfo(84,  0,2, 7, new Image()),
new GlyphInfo(85,  0,2, 8, new Image()),
new GlyphInfo(86,  0,2, 8, new Image()),
new GlyphInfo(87,  0,2, 9, new Image()),
new GlyphInfo(88,  0,2, 8, new Image()),
new GlyphInfo(89,  0,2, 7, new Image()),
new GlyphInfo(90,  0,2, 8, new Image()),
new GlyphInfo(91,  0,2, 5, new Image()),
new GlyphInfo(92,  0,2, 5, new Image()),
new GlyphInfo(93,  0,2, 5, new Image()),
new GlyphInfo(94,  0,2, 7, new Image()),
new GlyphInfo(95,  0,14,8, new Image()),
new GlyphInfo(96,  0,2, 5, new Image()),
...
new GlyphInfo(102, 0,2, 5, new Image()),
...
new GlyphInfo(116, 0,2, 5, new Image()),
...
new GlyphInfo(161, 0,5, 3, new Image()),
...
new GlyphInfo(353, 0,2, 7, new Image()),
new GlyphInfo(169, 0,2, 8, new Image()),
new GlyphInfo(170, 0,2, 6, new Image()),
new GlyphInfo(171, 0,6, 8, new Image()),
new GlyphInfo(172, 0,7, 7, new Image()),
new GlyphInfo(174, 0,2, 8, new Image()),
new GlyphInfo(175, 1,3, 14,new Image()),
new GlyphInfo(176, 0,2, 5, new Image()),
new GlyphInfo(177, 0,4, 7, new Image()),
new GlyphInfo(178, 0,2, 5, new Image()),
new GlyphInfo(179, 0,2, 5, new Image()),
new GlyphInfo(381, 0,1, 8, new Image()),
new GlyphInfo(181, 0,5, 7, new Image()),
new GlyphInfo(182, 0,2, 8, new Image()),
new GlyphInfo(183, 0,6, 3, new Image()),
new GlyphInfo(382, 0,2, 7, new Image()),
new GlyphInfo(185, 0,2, 4, new Image()),
new GlyphInfo(186, 0,2, 5, new Image()),
new GlyphInfo(187, 0,6, 8, new Image()),
new GlyphInfo(338, 0,2, 10,new Image()),
new GlyphInfo(339, 0,5, 9, new Image()),
new GlyphInfo(376, 0,1, 7, new Image()),
...
new GlyphInfo(198, 0,2, 10,new Image()),
new GlyphInfo(199, 0,2, 8, new Image()),
new GlyphInfo(200, 0,1, 8, new Image()),
new GlyphInfo(201, 0,1, 8, new Image()),
new GlyphInfo(202, 0,1, 8, new Image()),
...
new GlyphInfo(207, 0,1, 6, new Image()),
new GlyphInfo(208, 0,2, 9, new Image()),
...
new GlyphInfo(228, 0,2, 7, new Image()),
...
new GlyphInfo(235, 0,2, 7, new Image()),
new GlyphInfo(236, 0,2, 4, new Image()),
new GlyphInfo(237, 0,2, 4, new Image()),
new GlyphInfo(238, 0,2, 6, new Image()),
new GlyphInfo(239, 0,2, 6, new Image()),
...
new GlyphInfo(246, 0,2, 7, new Image()),
new GlyphInfo(247, 0,4, 7, new Image()),
new GlyphInfo(248, 0,3, 8, new Image()),
new GlyphInfo(249, 0,2, 7, new Image()),
new GlyphInfo(250, 0,2, 7, new Image()),
new GlyphInfo(251, 0,2, 7, new Image()),
new GlyphInfo(252, 0,2, 7, new Image()),
new GlyphInfo(253, 0,2, 7, new Image()),
new GlyphInfo(254, 0,2, 7, new Image()),
new GlyphInfo(255, 0,2, 7, new Image())
];

// Style loading function: Sunny
export function GuiLoadStyleSunny() {
    // Load style properties provided
    // NOTE: Default properties are propagated
    for (let i = 0; i < SUNNY_STYLE_PROPS_COUNT; i++) {
        GuiSetStyle(sunnyStyleProps[i].controlId, sunnyStyleProps[i].propertyId, sunnyStyleProps[i].propertyValue);
    }

    // Custom font loading
    // NOTE: Compressed font image data (DEFLATE), it requires DecompressData() function
    let sunnyFontDataSize = 0;
    let data = DecompressData(sunnyFontData, SUNNY_STYLE_FONT_ATLAS_COMP_SIZE, sunnyFontDataSize);
