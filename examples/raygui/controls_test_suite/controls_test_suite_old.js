...
import {
    ...
    DROPDOWNBOX,
    GuiButton,
    GuiCheckBox, GuiColorBarAlpha,
    GuiColorPicker,
    GuiComboBox,
    GuiDropdownBox, GuiEnable,
    GuiGetStyle, GuiGrid,
    GuiGroupBox,
    GuiIconText,
    GuiListView,
    GuiLoadStyle,
    GuiLoadStyleDefault,
    GuiLock, GuiMessageBox,
    GuiPanel, GuiProgressBar, GuiScrollPanel,
    GuiSetAlpha,
    GuiSetState,
    GuiSetStyle,
    GuiSlider, GuiSliderBar,
    GuiSpinner,
    GuiTextBox, GuiTextInputBox,
    GuiToggleGroup,
    GuiToggleSlider,
    GuiUnlock,
    GuiValueBox, ICON_EXIT,
    ICON_FILE_SAVE,
    LABEL,
    SLIDER,
    SLIDER_PADDING,
...
//old testsuite commit did use styles and we dont support it yet to switch to the new example
/*
import {GuiLoadStyleJungle} from "../styles/style_jungle.js";
import {GuiLoadStyleLavanda} from "../styles/style_lavanda.js";
import {GuiLoadStyleDark} from "../styles/style_dark.js";
import {GuiLoadStyleBluish} from "../styles/style_bluish.js";
import {GuiLoadStyleCyber} from "../styles/style_cyber.js";
import {GuiLoadStyleTerminal} from "../styles/style_terminal.js";
*/
{
