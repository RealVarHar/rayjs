...
*
********************************************************************************************/
//NOTE: (VARHAR) to get this working, we either have to implement
// 1) config pass-through via buildFlags or
// 2) split EndDrawing to EndDrawing and EndDrawingWait based on  SUPPORT_CUSTOM_FRAME_CONTROL
// option 1 seems faster to do and futureproof, but is harder for automatic tests
