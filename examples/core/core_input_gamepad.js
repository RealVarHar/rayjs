...
import {
    BeginDrawing, BLACK, BLUE, ClearBackground, CloseWindow, DARKGRAY, DrawCircle, DrawRectangle, DrawRectangleRounded, DrawText, DrawTexture, DrawTriangle, EndDrawing, FLAG_MSAA_4X_HINT, GAMEPAD_AXIS_LEFT_TRIGGER, GAMEPAD_AXIS_LEFT_X, GAMEPAD_AXIS_LEFT_Y, GAMEPAD_AXIS_RIGHT_TRIGGER, GAMEPAD_AXIS_RIGHT_X, GAMEPAD_AXIS_RIGHT_Y, GAMEPAD_BUTTON_LEFT_FACE_DOWN, GAMEPAD_BUTTON_LEFT_FACE_LEFT, GAMEPAD_BUTTON_LEFT_FACE_RIGHT, GAMEPAD_BUTTON_LEFT_FACE_UP, GAMEPAD_BUTTON_LEFT_THUMB, GAMEPAD_BUTTON_LEFT_TRIGGER_1, GAMEPAD_BUTTON_MIDDLE, GAMEPAD_BUTTON_MIDDLE_LEFT, GAMEPAD_BUTTON_MIDDLE_RIGHT, GAMEPAD_BUTTON_RIGHT_FACE_DOWN, GAMEPAD_BUTTON_RIGHT_FACE_LEFT, GAMEPAD_BUTTON_RIGHT_FACE_RIGHT, GAMEPAD_BUTTON_RIGHT_FACE_UP, GAMEPAD_BUTTON_RIGHT_THUMB, GAMEPAD_BUTTON_RIGHT_TRIGGER_1, GAMEPAD_BUTTON_UNKNOWN, GetGamepadAxisCount, GetGamepadAxisMovement, GetGamepadButtonPressed, GetGamepadName, GOLD, GRAY, GREEN, InitWindow, IsGamepadAvailable, IsGamepadButtonDown, IsKeyPressed, KEY_LEFT, KEY_RIGHT, LIGHTGRAY, LIME, LoadTexture, MAROON, PINK, RAYWHITE, Rectangle, RED, SetConfigFlags, SetTargetFPS, TextFindIndex, TextFormat, TextToLower, UnloadTexture, Vector2, VIOLET, WindowShouldClose
} from "rayjs:raylib";
