...
import {
    BeginDrawing, BLACK, ClearBackground, CloseWindow, DrawRectangle, DrawText, EndDrawing, InitWindow, IsKeyPressed, KEY_ESCAPE, KEY_N, KEY_NULL, KEY_Y, LIGHTGRAY, RAYWHITE, SetExitKey, SetTargetFPS, WHITE, WindowShouldClose
} from "rayjs:raylib";
