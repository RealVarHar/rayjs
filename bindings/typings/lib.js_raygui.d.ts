declare module "rayjs:raygui" {
    ...
    /** undefined */
    function GuiEnable(): void;
    /** undefined */
    function GuiDisable(): void;
    /** undefined */
    function GuiLock(): void;
    /** undefined */
    function GuiUnlock(): void;
    /** undefined */
    function GuiIsLocked(): boolean;
    /** undefined */
    function GuiSetAlpha(alpha: number): void;
    /** undefined */
    function GuiSetState(state: number): void;
    /** undefined */
    function GuiGetState(): number;
    /** undefined */
    function GuiSetFont(font: Font): void;
    /** undefined */
    function GuiGetFont(): Font;
    /** undefined */
    function GuiSetStyle(control: number, property: number, value: number): void;
    /** undefined */
    function GuiGetStyle(control: number, property: number): number;
    /** undefined */
    function GuiLoadStyle(fileName: string): void;
    /** undefined */
    function GuiLoadStyleDefault(): void;
    /** undefined */
    function GuiEnableTooltip(): void;
    /** undefined */
    function GuiDisableTooltip(): void;
    /** undefined */
    function GuiSetTooltip(tooltip: string): void;
    /** undefined */
    function GuiIconText(iconId: number, text: string): string;
    /** undefined */
    function GuiSetIconScale(scale: number): void;
    /** undefined */
    function GuiGetIcons(): number[];
    /** undefined */
    function GuiLoadIcons(fileName: string, loadIconsName: boolean): string[];
    /** undefined */
    function GuiDrawIcon(iconId: number, posX: number, posY: number, pixelSize: number, color: Color): void;
    /** undefined */
    function GuiWindowBox(bounds: Rectangle, title: string): number;
    /** undefined */
    function GuiGroupBox(bounds: Rectangle, text: string): number;
    /** undefined */
    function GuiLine(bounds: Rectangle, text: string): number;
    /** undefined */
    function GuiPanel(bounds: Rectangle, text: string): number;
    /** undefined */
    function GuiTabBar(bounds: Rectangle, text: string[], count: number, active: number | number[]): number;
    /** undefined */
    function GuiScrollPanel(bounds: Rectangle, text: string, content: Rectangle, scroll: Vector2, view: Rectangle): number;
    /** undefined */
    function GuiLabel(bounds: Rectangle, text: string): number;
    /** undefined */
    function GuiButton(bounds: Rectangle, text: string): number;
    /** undefined */
    function GuiLabelButton(bounds: Rectangle, text: string): number;
    /** undefined */
    function GuiToggle(bounds: Rectangle, text: string, active: boolean | boolean[]): number;
    /** undefined */
    function GuiToggleGroup(bounds: Rectangle, text: string, active: number | number[]): number;
    /** undefined */
    function GuiToggleSlider(bounds: Rectangle, text: string, active: number | number[]): number;
    /** undefined */
    function GuiCheckBox(bounds: Rectangle, text: string, checked: boolean | boolean[]): number;
    /** undefined */
    function GuiComboBox(bounds: Rectangle, text: string, active: number | number[]): number;
    /** undefined */
    function GuiDropdownBox(bounds: Rectangle, text: string, active: number | number[], editMode: boolean): number;
    /** undefined */
    function GuiSpinner(bounds: Rectangle, text: string, value: number | number[], minValue: number, maxValue: number, editMode: boolean): number;
    /** undefined */
    function GuiValueBox(bounds: Rectangle, text: string, value: number | number[], minValue: number, maxValue: number, editMode: boolean): number;
    /** undefined */
    function GuiValueBoxFloat(bounds: Rectangle, text: string, textValue: string, value: number | number[], editMode: boolean): number;
    /** undefined */
    function GuiTextBox(bounds: Rectangle, text: string | string[], textSize: number, editMode: boolean): number;
    /** undefined */
    function GuiSlider(bounds: Rectangle, textLeft: string, textRight: string, value: number | number[], minValue: number, maxValue: number): number;
    /** undefined */
    function GuiSliderBar(bounds: Rectangle, textLeft: string, textRight: string, value: number | number[], minValue: number, maxValue: number): number;
    /** undefined */
    function GuiProgressBar(bounds: Rectangle, textLeft: string, textRight: string, value: number | number[], minValue: number, maxValue: number): number;
    /** undefined */
    function GuiStatusBar(bounds: Rectangle, text: string): number;
    /** undefined */
    function GuiDummyRec(bounds: Rectangle, text: string): number;
    /** undefined */
    function GuiGrid(bounds: Rectangle, text: string, spacing: number, subdivs: number, mouseCell: Vector2): number;
    /** undefined */
    function GuiListView(bounds: Rectangle, text: string, scrollIndex: number | number[], active: number | number[]): number;
    /** undefined */
    function GuiListViewEx(bounds: Rectangle, text: string[], count: number, scrollIndex: number | number[], active: number | number[], focus: number[]): number;
    /** undefined */
    function GuiMessageBox(bounds: Rectangle, title: string, message: string, buttons: string): number;
    /** undefined */
    function GuiTextInputBox(bounds: Rectangle, title: string, message: string, buttons: string, text: string, textMaxSize: number, secretViewActive: boolean[]): number;
    /** undefined */
    function GuiColorPicker(bounds: Rectangle, text: string, color: Color): number;
    /** undefined */
    function GuiColorPanel(bounds: Rectangle, text: string, color: Color): number;
    /** undefined */
    function GuiColorBarAlpha(bounds: Rectangle, text: string, alpha: number | number[]): number;
    /** undefined */
    function GuiColorBarHue(bounds: Rectangle, text: string, value: number | number[]): number;
    /** undefined */
    function GuiColorPickerHSV(bounds: Rectangle, text: string, colorHsv: Vector3): number;
    /** undefined */
