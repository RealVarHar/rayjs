declare module "rayjs:rlgl" {
    ...
    /** undefined */
    function rlMultMatrixf(matf: number | number[]): void;
    /** undefined */
    function rlFrustum(left: number, right: number, bottom: number, top: number, znear: number, zfar: number): void;
    /** undefined */
    function rlOrtho(left: number, right: number, bottom: number, top: number, znear: number, zfar: number): void;
    /** undefined */
    function rlViewport(x: number, y: number, width: number, height: number): void;
    /** undefined */
    function rlSetClipPlanes(nearPlane: number, farPlane: number): void;
    /** undefined */
    function rlGetCullDistanceNear(): number;
    /** undefined */
    function rlGetCullDistanceFar(): number;
    /** undefined */
    ...
    /** undefined */
    function rlEnableVertexArray(vaoId: number): boolean;
    /** undefined */
    function rlDisableVertexArray(): void;
    /** undefined */
    function rlEnableVertexBuffer(id: number): void;
    /** undefined */
    function rlDisableVertexBuffer(): void;
    /** undefined */
    function rlEnableVertexBufferElement(id: number): void;
    /** undefined */
    function rlDisableVertexBufferElement(): void;
    /** undefined */
    function rlEnableVertexAttribute(index: number): void;
    /** undefined */
    function rlDisableVertexAttribute(index: number): void;
    /** undefined */
    function rlActiveTextureSlot(slot: number): void;
    /** undefined */
    function rlEnableTexture(id: number): void;
    /** undefined */
    function rlDisableTexture(): void;
    /** undefined */
    function rlEnableTextureCubemap(id: number): void;
    /** undefined */
    function rlDisableTextureCubemap(): void;
    /** undefined */
    function rlTextureParameters(id: number, param: number, value: number): void;
    /** undefined */
    function rlCubemapParameters(id: number, param: number, value: number): void;
    /** undefined */
    function rlEnableShader(id: number): void;
    /** undefined */
    function rlDisableShader(): void;
    /** undefined */
    function rlEnableFramebuffer(id: number): void;
    /** undefined */
    function rlDisableFramebuffer(): void;
    /** undefined */
    function rlGetActiveFramebuffer(): number;
    /** undefined */
    function rlActiveDrawBuffers(count: number): void;
    /** undefined */
    function rlBlitFramebuffer(srcX: number, srcY: number, srcWidth: number, srcHeight: number, dstX: number, dstY: number, dstWidth: number, dstHeight: number, bufferMask: number): void;
    /** undefined */
    function rlBindFramebuffer(target: number, framebuffer: number): void;
    /** undefined */
    function rlEnableColorBlend(): void;
    /** undefined */
    function rlDisableColorBlend(): void;
    /** undefined */
    function rlEnableDepthTest(): void;
    /** undefined */
    function rlDisableDepthTest(): void;
    /** undefined */
    function rlEnableDepthMask(): void;
    /** undefined */
    function rlDisableDepthMask(): void;
    /** undefined */
    function rlEnableBackfaceCulling(): void;
    /** undefined */
    function rlDisableBackfaceCulling(): void;
    /** undefined */
    function rlColorMask(r: boolean, g: boolean, b: boolean, a: boolean): void;
    /** undefined */
    function rlSetCullFace(mode: number): void;
    /** undefined */
    function rlEnableScissorTest(): void;
    /** undefined */
    function rlDisableScissorTest(): void;
    /** undefined */
    function rlScissor(x: number, y: number, width: number, height: number): void;
    /** undefined */
    function rlEnablePointMode(): void;
    /** undefined */
    function rlDisablePointMode(): void;
    /** undefined */
    function rlEnableWireMode(): void;
    /** undefined */
    function rlDisableWireMode(): void;
    /** undefined */
    function rlSetLineWidth(width: number): void;
    /** undefined */
    function rlGetLineWidth(): number;
    /** undefined */
    function rlEnableSmoothLines(): void;
    /** undefined */
    function rlDisableSmoothLines(): void;
    /** undefined */
    function rlEnableStereoRender(): void;
    /** undefined */
    function rlDisableStereoRender(): void;
    /** undefined */
    function rlIsStereoRenderEnabled(): boolean;
    /** undefined */
    function rlClearColor(r: number, g: number, b: number, a: number): void;
    /** undefined */
    function rlClearScreenBuffers(): void;
    /** undefined */
    function rlCheckErrors(): void;
    /** undefined */
    function rlSetBlendMode(mode: number): void;
    /** undefined */
    function rlSetBlendFactors(glSrcFactor: number, glDstFactor: number, glEquation: number): void;
    /** undefined */
    function rlSetBlendFactorsSeparate(glSrcRGB: number, glDstRGB: number, glSrcAlpha: number, glDstAlpha: number, glEqRGB: number, glEqAlpha: number): void;
    /** undefined */
    function rlglInit(width: number, height: number): void;
    /** undefined */
    function rlglClose(): void;
    /** undefined */
    function rlGetVersion(): number;
    /** undefined */
    function rlSetFramebufferWidth(width: number): void;
    /** undefined */
    function rlGetFramebufferWidth(): number;
    /** undefined */
    function rlSetFramebufferHeight(height: number): void;
    /** undefined */
    function rlGetFramebufferHeight(): number;
    /** undefined */
    function rlGetTextureIdDefault(): number;
    /** undefined */
    function rlGetShaderIdDefault(): number;
    /** undefined */
    function rlGetShaderLocsDefault(): number[];
    /** undefined */
    function rlLoadRenderBatch(numBuffers: number, bufferElements: number): rlRenderBatch;
    /** undefined */
    function rlUnloadRenderBatch(batch: rlRenderBatch): void;
    /** undefined */
    function rlDrawRenderBatch(batch: rlRenderBatch): void;
    /** undefined */
    function rlSetRenderBatchActive(batch: rlRenderBatch): void;
    /** undefined */
    function rlDrawRenderBatchActive(): void;
    /** undefined */
    function rlCheckRenderBatchLimit(vCount: number): boolean;
    /** undefined */
    function rlSetTexture(id: number): void;
    /** undefined */
    function rlLoadVertexArray(): number;
    /** undefined */
    function rlLoadVertexBuffer(buffer: ArrayBuffer, size: number, dynamic: boolean): number;
    /** undefined */
    function rlLoadVertexBufferElement(buffer: ArrayBuffer, size: number, dynamic: boolean): number;
    /** undefined */
    function rlUpdateVertexBuffer(bufferId: number, data: ArrayBuffer, dataSize: number, offset: number): void;
    /** undefined */
    function rlUpdateVertexBufferElements(id: number, data: ArrayBuffer, dataSize: number, offset: number): void;
    /** undefined */
    function rlUnloadVertexArray(vaoId: number): void;
    /** undefined */
    function rlUnloadVertexBuffer(vboId: number): void;
    /** undefined */
    function rlSetVertexAttribute(index: number, compSize: number, type: number, normalized: boolean, stride: number, offset: number): void;
    /** undefined */
    function rlSetVertexAttributeDivisor(index: number, divisor: number): void;
    /** undefined */
    function rlDrawVertexArray(offset: number, count: number): void;
    /** undefined */
    function rlDrawVertexArrayElements(offset: number, count: number, buffer: ArrayBuffer): void;
    /** undefined */
    function rlDrawVertexArrayInstanced(offset: number, count: number, instances: number): void;
    /** undefined */
    function rlDrawVertexArrayElementsInstanced(offset: number, count: number, buffer: ArrayBuffer, instances: number): void;
    /** undefined */
    function rlLoadTexture(data: ArrayBuffer, width: number, height: number, format: number, mipmapCount: number): number;
    /** undefined */
    function rlLoadTextureDepth(width: number, height: number, useRenderBuffer: boolean): number;
    /** undefined */
    function rlLoadTextureCubemap(data: ArrayBuffer, size: number, format: number, mipmapCount: number): number;
    /** undefined */
    function rlUpdateTexture(id: number, offsetX: number, offsetY: number, width: number, height: number, format: number, data: ArrayBuffer): void;
    /** undefined */
    function rlGetGlTextureFormats(format: number, glInternalFormat: number[], glFormat: number[], glType: number[]): void;
    /** undefined */
    function rlGetPixelFormatName(format: number): string;
    /** undefined */
    function rlUnloadTexture(id: number): void;
    /** undefined */
    function rlGenTextureMipmaps(id: number, width: number, height: number, format: number, mipmaps: number[]): void;
    /** undefined */
    function rlReadTexturePixels(id: number, width: number, height: number, format: number): ArrayBuffer;
    /** undefined */
    function rlReadScreenPixels(width: number, height: number): number[];
    /** undefined */
    function rlLoadFramebuffer(): number;
    /** undefined */
    function rlFramebufferAttach(fboId: number, texId: number, attachType: number, texType: number, mipLevel: number): void;
    /** undefined */
    function rlFramebufferComplete(id: number): boolean;
    /** undefined */
    function rlUnloadFramebuffer(id: number): void;
    /** undefined */
    function rlLoadShaderCode(vsCode: string, fsCode: string): number;
    /** undefined */
    function rlCompileShader(shaderCode: string, type: number): number;
    /** undefined */
    function rlLoadShaderProgram(vShaderId: number, fShaderId: number): number;
    /** undefined */
    function rlUnloadShaderProgram(id: number): void;
    /** undefined */
    function rlGetLocationUniform(shaderId: number, uniformName: string): number;
    /** undefined */
    function rlGetLocationAttrib(shaderId: number, attribName: string): number;
    /** undefined */
    function rlSetUniformMatrix(locIndex: number, mat: Matrix): void;
    /** undefined */
    function rlSetUniformMatrices(locIndex: number, mat: Matrix[], count: number): void;
    /** undefined */
    function rlSetUniformSampler(locIndex: number, textureId: number): void;
    /** undefined */
    function rlSetShader(id: number, locs: number[]): void;
    /** undefined */
    function rlLoadComputeShaderProgram(shaderId: number): number;
    /** undefined */
    function rlComputeShaderDispatch(groupX: number, groupY: number, groupZ: number): void;
    /** undefined */
    function rlLoadShaderBuffer(size: number, data: ArrayBuffer, usageHint: number): number;
    /** undefined */
    function rlUnloadShaderBuffer(ssboId: number): void;
    /** undefined */
    function rlUpdateShaderBuffer(id: number, data: ArrayBuffer, dataSize: number, offset: number): void;
    /** undefined */
    function rlBindShaderBuffer(id: number, index: number): void;
    /** undefined */
    function rlReadShaderBuffer(id: number, dest: ArrayBuffer, count: number, offset: number): void;
    /** undefined */
    function rlCopyShaderBuffer(destId: number, srcId: number, destOffset: number, srcOffset: number, count: number): void;
    /** undefined */
    function rlGetShaderBufferSize(id: number): number;
    /** undefined */
    function rlBindImageTexture(id: number, index: number, format: number, readonly: boolean): void;
    /** undefined */
    function rlGetMatrixModelview(): Matrix;
    /** undefined */
    function rlGetMatrixProjection(): Matrix;
    /** undefined */
    function rlGetMatrixTransform(): Matrix;
    /** undefined */
    function rlGetMatrixProjectionStereo(eye: number): Matrix;
    /** undefined */
    function rlGetMatrixViewOffsetStereo(eye: number): Matrix;
    /** undefined */
    function rlSetMatrixProjection(proj: Matrix): void;
    /** undefined */
    function rlSetMatrixModelview(view: Matrix): void;
    /** undefined */
    function rlSetMatrixProjectionStereo(right: Matrix, left: Matrix): void;
    /** undefined */
    function rlSetMatrixViewOffsetStereo(right: Matrix, left: Matrix): void;
    /** undefined */
    function rlLoadDrawCube(): void;
    /** undefined */
